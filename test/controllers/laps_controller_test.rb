...
class LapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lap" do
    assert_difference('Lap.count') do
      post laps_url, params: { lap: { lap_number: @lap.lap_number, pilot_id: @lap.pilot_id, position: @lap.position, race_id: @lap.race_id, time: @lap.time } }
    end
  ...
  test "should update lap" do
    patch lap_url(@lap), params: { lap: { lap_number: @lap.lap_number, pilot_id: @lap.pilot_id, position: @lap.position, race_id: @lap.race_id, time: @lap.time } }
